...
http://search.cpan.org/dist/Char-OldUTF8/OldUTF8/JA.pm
...
Definitions in Eoldutf8.pm.
  ...
  @{Eoldutf8::eV}             qr{(?:(?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x00-\xFF]|[^\x80-\xFF\x0C\x0A\x0D])}
...
=item * Length By old UTF-8 Character
  ...
  $string is omitted, it returns the OldUTF8::length of $_.
...
=item * Substr By old UTF-8 Character
  ...
  area past the end of the string, OldUTF8::substr raises an exception.
...
=item * Rindex By old UTF-8 Character
  ...
  $rindex = OldUTF8::rindex($string,$substring,$position);
  $rindex = OldUTF8::rindex($string,$substring);

  This function works just like OldUTF8::index except that it returns the position of
