...
=item * Only OldUTF8.pm and Eoldutf8.pm, other modules are unnecessary
...
OldUTF8.pm remove 'bytes::' at head of function name.
...
OldUTF8.pm remove '\' at head of alphanumeric regexp metasymbols \N, \p, \P
