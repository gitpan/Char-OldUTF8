...
# ${Eoldutf8::eS}        = qr{(?:(?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x80-\xBF]|[^\x80-\xFF\x09\x0A\x0B\x0C\x0D\x20])};
...
This module is a run-time routines of the OldUTF8.pm.
Because the OldUTF8.pm automatically uses this module, you need not use directly.
...
=item Chop string
  ...
  character chopped. The Eoldutf8::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Eoldutf8::index except that it returns the byte
...
=item Lower case string
  ...
  You can use the Eoldutf8::fc function for case-insensitive comparisons via OldUTF8
  software.
...
=item Fold case string
  ...
  New to OldUTF8 software, this function returns the full Unicode-like casefold of
...
=item Filename expansion (globbing)
  ...
  The Eoldutf8::glob function grandfathers the use of whitespace to separate multiple
