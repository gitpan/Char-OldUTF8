...
=item * Possible to handle raw old UTF-8 values

=item * Backward compatibility of data, script and how to

=item * Only Char/OldUTF8.pm and Char/Eoldutf8.pm, other modules are unnecessary
...
Char/OldUTF8.pm remove 'bytes::' at head of function name.
...
Char/OldUTF8.pm remove '\' at head of alphanumeric regexp metasymbols \N, \p, \P
...
oriented function. See 'CHARACTER ORIENTED FUNCTIONS'.
  ...
  index       Char::OldUTF8::index
  rindex      Char::OldUTF8::rindex
  ---------------------------------
