...
sub Char::OldUTF8::escape_script {
    ...
    if (/^ use Char::Eoldutf8(?:\s+[0-9\.]*)?\s*; $/oxms) {
        ...
        # use Char::OldUTF8 version qw(ord reverse);
        $function_ord     = 'ord';
        $function_ord_    = 'ord';
...
=head1 SYNOPSIS
  ...
  use Char::OldUTF8 qw(ord reverse); --- demand enhanced feature of ord and reverse
  use Char::OldUTF8 ver.sion qw(ord reverse);
  use Char::OldUTF8 ver.sion.0 qw(ord reverse);
