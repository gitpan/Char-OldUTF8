...
$VERSION = sprintf '%d.%02d', q$Revision: 0.72 $ =~ m/(\d+)/oxmsg;
...
=item * binmode (Perl5.6 emulation on perl5.005)
  ...
  * two arguments
  ...
  If you are using perl5.005, Char::OldUTF8 software emulate perl5.6's binmode function.
...
=head1 Ignore utf8 pragma
  ...
  ---------------------------------------------------------------------
  use utf8;       # use utf8;            Char/Eoldutf8.pm provides utf8::*
  no utf8;        # no utf8;             functions even if 'no utf8;'
  use bytes;      # use bytes;           Char/Eoldutf8.pm provides bytes::*
