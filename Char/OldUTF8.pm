...
# subroutines of package Char::Eoldutf8
...
=item * Ordinal Value of Character
  ...
  This subroutine returns the numeric value (ASCII or old UTF-8 character) of the
...
=item * Returns Next Character
  ...
  If you import getc "use Char::OldUTF8 qw(getc);", getc of your script will be rewritten
  in Char::OldUTF8::getc. Char::OldUTF8::getc is not compatible with getc of JPerl.
...
=item * Length by old UTF-8 Character
  ...
  of the scalar value $string. If $string is omitted, it returns the Char::OldUTF8::length
  of $_.
...
=item * Substr by old UTF-8 Character
  ...
  If Perl version 5.14 or later, you can use the Char::OldUTF8::substr() subroutine as an
...
=item * Rindex by old UTF-8 Character
  ...
  This subroutine works just like Char::OldUTF8::index except that it returns the character
...
=item * Filename Globbing
  ...
  This operator is implemented via the Char::Eoldutf8::glob() subroutine. See Char::Eoldutf8::glob
  of Char/Eoldutf8.pm for details.
...
=head1 Un-Escaping bytes::* Subroutines (Char/OldUTF8.pm provides)

Char/OldUTF8.pm removes 'bytes::' at head of subroutine name.
...
If Perl version is older than 5.14, Char::OldUTF8::substr differs from CORE::substr, and
