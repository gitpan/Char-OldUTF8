...
Let's start with a bit of history: jperl 4.019+1.3 introduced old UTF-8 support.
...
In this country, old UTF-8 is widely used on mainframe I/O, the personal computer,
and the cellular phone. This software treats old UTF-8 directly, but doesn't treat
