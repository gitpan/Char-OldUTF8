...
sub Char::Eoldutf8::lcfirst(@);
sub Char::Eoldutf8::lcfirst_();
sub Char::Eoldutf8::lc(@);
sub Char::Eoldutf8::lc_();
sub Char::Eoldutf8::ucfirst(@);
sub Char::Eoldutf8::ucfirst_();
sub Char::Eoldutf8::uc(@);
...
# ${Char::Eoldutf8::eS}        = qr{(?:(?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x80-\xBF]|[^\x80-\xFF\x09\x0A\x0B\x0C\x0D\x20])};
...
# avoid: Name "Char::Eoldutf8::foo" used only once: possible typo at here.
${Char::Eoldutf8::dot}         = ${Char::Eoldutf8::dot};
${Char::Eoldutf8::dot_s}       = ${Char::Eoldutf8::dot_s};
${Char::Eoldutf8::eD}          = ${Char::Eoldutf8::eD};
${Char::Eoldutf8::eS}          = ${Char::Eoldutf8::eS};
${Char::Eoldutf8::eW}          = ${Char::Eoldutf8::eW};
${Char::Eoldutf8::eH}          = ${Char::Eoldutf8::eH};
${Char::Eoldutf8::eV}          = ${Char::Eoldutf8::eV};
${Char::Eoldutf8::eR}          = ${Char::Eoldutf8::eR};
${Char::Eoldutf8::eN}          = ${Char::Eoldutf8::eN};
${Char::Eoldutf8::not_alnum}   = ${Char::Eoldutf8::not_alnum};
${Char::Eoldutf8::not_alpha}   = ${Char::Eoldutf8::not_alpha};
${Char::Eoldutf8::not_ascii}   = ${Char::Eoldutf8::not_ascii};
${Char::Eoldutf8::not_blank}   = ${Char::Eoldutf8::not_blank};
${Char::Eoldutf8::not_cntrl}   = ${Char::Eoldutf8::not_cntrl};
${Char::Eoldutf8::not_digit}   = ${Char::Eoldutf8::not_digit};
${Char::Eoldutf8::not_graph}   = ${Char::Eoldutf8::not_graph};
${Char::Eoldutf8::not_lower}   = ${Char::Eoldutf8::not_lower};
${Char::Eoldutf8::not_lower_i} = ${Char::Eoldutf8::not_lower_i};
${Char::Eoldutf8::not_print}   = ${Char::Eoldutf8::not_print};
${Char::Eoldutf8::not_punct}   = ${Char::Eoldutf8::not_punct};
${Char::Eoldutf8::not_space}   = ${Char::Eoldutf8::not_space};
${Char::Eoldutf8::not_upper}   = ${Char::Eoldutf8::not_upper};
${Char::Eoldutf8::not_upper_i} = ${Char::Eoldutf8::not_upper_i};
${Char::Eoldutf8::not_word}    = ${Char::Eoldutf8::not_word};
${Char::Eoldutf8::not_xdigit}  = ${Char::Eoldutf8::not_xdigit};
${Char::Eoldutf8::eb}          = ${Char::Eoldutf8::eb};
${Char::Eoldutf8::eB}          = ${Char::Eoldutf8::eB};
...
sub Char::Eoldutf8::lcfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Eoldutf8::lc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Eoldutf8::lc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Eoldutf8::lc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
...
sub Char::Eoldutf8::ucfirst(@) {
    if (@_) {
        my $s = shift @_;
        if (@_ and wantarray) {
            return Char::Eoldutf8::uc(CORE::substr($s,0,1)) . CORE::substr($s,1), @_;
        }
        else {
            return Char::Eoldutf8::uc(CORE::substr($s,0,1)) . CORE::substr($s,1);
        }
    }
    else {
        return Char::Eoldutf8::uc(CORE::substr($_,0,1)) . CORE::substr($_,1);
    }
}
    ...
    for my $string (@string) {
        ...
        for (my $i=0; $i <= $#char; $i++) {
            ...
            # with /i modifier
                ...
                my $uc = Char::Eoldutf8::uc($char[$i]);
                my $fc = Char::Eoldutf8::fc($char[$i]);
                if ($uc ne $fc) {
                    if (CORE::length($fc) == 1) {
                        $char[$i] = '['   . $uc       . $fc . ']';
                    }
            ...
            for (@singleoctet) {
                while (s/ \A \\x(..) - \\x(..) //oxms or s/ \A \\x((..)) //oxms) {
                    for my $ord (hex($1) .. hex($2)) {
                        ...
                        my $uc = Char::Eoldutf8::uc($char);
                        my $fc = Char::Eoldutf8::fc($char);
                        if ($uc eq $fc) {
...
sub charlist_not_qr {
    ...
    if (scalar(@multipleoctet) >= 1) {
        if (scalar(@singleoctet) >= 1) {
            ...
            return '(?!' . join('|', @multipleoctet) . ')(?:(?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x80-\xBF]|[^\x80-\xFF' . join('', @singleoctet) . '])';
        }
        else {
        ...
        if (scalar(@singleoctet) >= 1) {
            ...
            return                                      '(?:(?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x80-\xBF]|[^\x80-\xFF' . join('', @singleoctet) . '])';
        }
        else {
...
sub _DOS_like_glob {
    ...
    # UNIX-like system
        ...
        $expr =~ s{ \A ~ ( (?:(?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x80-\xBF]|[^\x80-\xFF/])* ) }
...
OUTER:
    for my $expr (@expr) {
        ...
        if ($^O =~ /\A (?: MSWin32 | NetWare | symbian | dos ) \z/oxms) {
            if ($expr =~ s# \A ((?:[A-Za-z]:)?) ((?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x80-\xBF]|[^\x80-\xFF/\\]) #$1./$2#oxms) {
...
#               $pattern .= "(?:$your_char)",   # UNIX style
            ...
            elsif ((my $fc = Char::Eoldutf8::fc($char)) ne $char) {
                $pattern .= $fc;
            }
            else {
        ...
        my $matchsub = sub { Char::Eoldutf8::fc($_[0]) =~ /\A $pattern \z/xms };
...
sub _parse_line {
    ...
    my @piece = ();
    while ($line =~ /
        " ( (?: (?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x80-\xBF]|[^\x80-\xFF"]   )*  ) " \s+ |
          ( (?: (?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x80-\xBF]|[^\x80-\xFF"\s] )*  )   \s+
        /oxmsg
    ) {
...
sub _parse_path {
    ...
    my @subpath = ();
    while ($path =~ /
        ((?: (?:[\xC0-\xDF]|[\xE0-\xEF][\x80-\xBF]|[\xF0-\xF4][\x80-\xBF][\x80-\xBF])[\x80-\xBF]|[^\x80-\xFF\/\\] )+?) [\/\\]
        /oxmsg
    ) {
        push @subpath, $1;
    }
...
sub Char::OldUTF8::escape(;$) {
    ...
    while (not /\G \z/oxgc) { # member
        $e_script .= Char::OldUTF8::escape_token();
    }
...
# subroutines of package Char::Eoldutf8
    ...
    elsif (/\G \b Char::OldUTF8::eval       (?= \s* \{ )                /oxgc) { $slash = 'm//'; return 'eval';              }
    elsif (/\G \b Char::OldUTF8::eval    \b (?! \s* => )                /oxgc) { $slash = 'm//'; return 'eval Char::OldUTF8::escape'; }
...
# subroutines of package Char::Eoldutf8
        ...
        elsif ($string =~ /\G \b Char::OldUTF8::eval       (?= \s* \{ )                /oxgc) { $e_string .= 'eval';              $slash = 'm//'; }
        elsif ($string =~ /\G \b Char::OldUTF8::eval \b                                /oxgc) { $e_string .= 'eval Char::OldUTF8::escape'; $slash = 'm//'; }
...
sub e_sub {
    ...
    if ($r_modifier) {
        ...
        # s///gr without multibyte anchoring
            ...
            $sub = sprintf(
                #                              1                        2   3                                 4   5
                q<CORE::eval{local $Char::OldUTF8::re_t=%s; while($Char::OldUTF8::re_t =~ %s){%s local $^W=0; local $Char::OldUTF8::re_r=%s; %s$Char::OldUTF8::re_t="$`$Char::OldUTF8::re_r$'"; pos($Char::OldUTF8::re_t)=length "$`$Char::OldUTF8::re_r"; } return $Char::OldUTF8::re_t}>,
                ...
                $s_matched,                                                      #  3
                $e_replacement,                                                  #  4
                '$Char::OldUTF8::re_r=CORE::eval $Char::OldUTF8::re_r; ' x $e_modifier,            #  5
            );
        }
        ...
        # s///r
            ...
            $sub = sprintf(
                #  1     2                3                                 4   5  6                    7
                q<(%s =~ %s) ? CORE::eval{%s local $^W=0; local $Char::OldUTF8::re_r=%s; %s"%s$Char::OldUTF8::re_r$'" } : %s>,
    ...
    # without /r
        ...
        # s///g without multibyte anchoring
            ...
            $sub = sprintf(
                #                                       1     2   3                                 4   5 6                         7                                                 8
                q<CORE::eval{local $Char::OldUTF8::re_n=0; while(%s =~ %s){%s local $^W=0; local $Char::OldUTF8::re_r=%s; %s%s="$`$Char::OldUTF8::re_r$'"; pos(%s)=length "$`$Char::OldUTF8::re_r"; $Char::OldUTF8::re_n++} return %s$Char::OldUTF8::re_n}>,
        ...
        # s///
            ...
            $sub = sprintf(
                ...
                #  1 2 3                4                                 5   6 7   8
                q<(%s%s%s) ? CORE::eval{%s local $^W=0; local $Char::OldUTF8::re_r=%s; %s%s="%s$Char::OldUTF8::re_r$'"; 1 } : undef> :

                #  1 2 3                    4                                 5   6 7   8
                q<(%s%s%s) ? 1 : CORE::eval{%s local $^W=0; local $Char::OldUTF8::re_r=%s; %s%s="%s$Char::OldUTF8::re_r$'"; undef }>,
                ...
                $s_matched,                                                      #  4
                $e_replacement,                                                  #  5
                '$Char::OldUTF8::re_r=CORE::eval $Char::OldUTF8::re_r; ' x $e_modifier,            #  6
                $variable,                                                       #  7
                $prematch,                                                       #  8
            );
        }
...
=head1 SYNOPSIS
  ...
  use Char::Eoldutf8;
    ...
    Char::Eoldutf8::lc(...);
    Char::Eoldutf8::lc_;
    Char::Eoldutf8::lcfirst(...);
    Char::Eoldutf8::lcfirst_;
    Char::Eoldutf8::uc(...);
    Char::Eoldutf8::uc_;
    Char::Eoldutf8::ucfirst(...);
    Char::Eoldutf8::ucfirst_;
    Char::Eoldutf8::fc(...);
    Char::Eoldutf8::fc_;
    Char::Eoldutf8::ignorecase(...);
...
This module has run-time routines for use Char::OldUTF8 software automatically, you
do not have to use.
...
=item Split string
  ...
  at all, Char::Eoldutf8::split returns the original string as a single substring, If it
  ...
  @chars  = Char::Eoldutf8::split(//,  $word);
  @fields = Char::Eoldutf8::split(/:/, $line);
  @words  = Char::Eoldutf8::split(" ", $paragraph);
  @lines  = Char::Eoldutf8::split(/^/, $buffer);
  ...
  print join(":" => Char::Eoldutf8::split(/ */, "hi there"));
  ...
  Char::Eoldutf8::split's pattern is exempt from that wrinkle.)

  The $limit parameter splits only part of a string:

  my ($login, $passwd, $remainder) = Char::Eoldutf8::split(/:/, $_, 3);
  ...
  splits on whitespace just as Char::Eoldutf8::split with no arguments does. Thus,
  Char::Eoldutf8::split(" ") can be used to emulate awk's default behavior. In contrast,
  Char::Eoldutf8::split(/ /) will give you as many null initial fields as there are
  ...
  $string = join(" ", Char::Eoldutf8::split(" ", $string));
  ...
  %head = ("FRONTSTUFF", Char::Eoldutf8::split(/^(\S*?):\s*/m, $header));
  ...
  while (<>) {
      for my $word (Char::Eoldutf8::split()) {
          $count{$word}++;
      }
  }

  The inverse of Char::Eoldutf8::split is join, except that join can only join with the
...
=item Transliteration
  ...
  print Char::Eoldutf8::tr('bookkeeper','=~','boep','peob','r'); # prints 'peekkoobor'
...
=item Chop string
  ...
  character chopped. The Char::Eoldutf8::chop subroutine is used primary to remove the newline
  ...
  since Char::Eoldutf8::chop always shortens the string no matter what's there, and chomp
  is more selective. If no argument is given, the subroutine chops the $_ variable.

  You cannot Char::Eoldutf8::chop a literal, only a variable. If you Char::Eoldutf8::chop a list of
  variables, each string in the list is chopped:

  @lines = `cat myfile`;
  Char::Eoldutf8::chop(@lines);

  You can Char::Eoldutf8::chop anything that is an lvalue, including an assignment:

  Char::Eoldutf8::chop($cwd = `pwd`);
  Char::Eoldutf8::chop($answer = <STDIN>);

  This is different from:

  $answer = Char::Eoldutf8::chop($tmp = <STDIN>); # WRONG

  which puts a newline into $answer because Char::Eoldutf8::chop returns the character
  ...
  In the most general case, Char::Eoldutf8::chop can be expressed using substr:

  $last_code = Char::Eoldutf8::chop($var);
  $last_code = substr($var, -1, 1, ""); # same thing

  Once you understand this equivalence, you can use it to do bigger chops. To
  Char::Eoldutf8::chop more than one character, use substr as an lvalue, assigning a null
  ...
  form of substr, creating something of a quintuple Char::Eoldutf8::chop;
...
=item Index string
  ...
  $byte_pos = Char::Eoldutf8::index($string,$substr,$byte_offset);
  $byte_pos = Char::Eoldutf8::index($string,$substr);
  ...
  $byte_pos = -1;
  while (($byte_pos = Char::Eoldutf8::index($string, $lookfor, $byte_pos)) > -1) {
...
=item Reverse index string
  ...
  $byte_pos = Char::Eoldutf8::rindex($string,$substr,$byte_offset);
  $byte_pos = Char::Eoldutf8::rindex($string,$substr);

  This subroutine works just like Char::Eoldutf8::index except that it returns the byte
  position of the last occurrence of $substring in $string (a reverse Char::Eoldutf8::index).
  ...
  while (($byte_pos = Char::OldUTF8::rindex($string, $lookfor, $byte_pos)) >= 0) {
      print "Found at $byte_pos\n";
      $byte_pos--;
  }
...
=item Lower case string
  ...
  $lc = Char::Eoldutf8::lc($string);
  $lc = Char::Eoldutf8::lc_;
  ...
  You can use the Char::Eoldutf8::fc subroutine for case-insensitive comparisons via Char::OldUTF8
  software.

=item Lower case first character of string

  $lcfirst = Char::Eoldutf8::lcfirst($string);
  $lcfirst = Char::Eoldutf8::lcfirst_;
...
=item Upper case string
  ...
  $uc = Char::Eoldutf8::uc($string);
  $uc = Char::Eoldutf8::uc_;
  ...
  in interpolated strings. For titlecase, use Char::Eoldutf8::ucfirst instead.
...
=item Upper case first character of string
  ...
  $ucfirst = Char::Eoldutf8::ucfirst($string);
  $ucfirst = Char::Eoldutf8::ucfirst_;
  ...
  $titlecase = Char::Eoldutf8::ucfirst(substr($word,0,1)) . Char::Eoldutf8::lc(substr($word,1));
  ...
  $do_not_use = Char::Eoldutf8::ucfirst(Char::Eoldutf8::lc($word));
...
=item Fold case string
  ...
  $fc = Char::Eoldutf8::fc($string);
  $fc = Char::Eoldutf8::fc_;

  New to Char::OldUTF8 software, this subroutine returns the full Unicode-like casefold of
  ...
  Char::Eoldutf8::fc($a) eq Char::Eoldutf8::fc($b)

  The reliable way to compare string case-insensitively was with the /i pattern
  modifier, because Char::OldUTF8 software has always used casefolding semantics for
...
=item Make ignore case string
  ...
  @ignorecase = Char::Eoldutf8::ignorecase(@string);
...
=item Make character
  ...
  that $code in the character set. For example, Char::Eoldutf8::chr(65) is "A" in either
  ASCII or old UTF-8, not Unicode. For the reverse of Char::Eoldutf8::chr, use Char::OldUTF8::ord.
...
=item Filename expansion (globbing)
  ...
  The Char::Eoldutf8::glob subroutine grandfathers the use of whitespace to separate multiple
  ...
  @spacies = <"*e f*">;
  @spacies = Char::Eoldutf8::glob('"*e f*"');
  @spacies = Char::Eoldutf8::glob(q("*e f*"));

  If you had to get a variable through, you could do this:

  @spacies = Char::Eoldutf8::glob("'*${var}e f*'");
  @spacies = Char::Eoldutf8::glob(qq("*${var}e f*"));
