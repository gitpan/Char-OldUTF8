...
=item Chop string
  ...
  character chopped. The Char::Eoldutf8::chop function is used primary to remove the newline
...
=item Reverse index string
  ...
  This function works just like Char::Eoldutf8::index except that it returns the byte
...
=item Lower case string
  ...
  This function returns a lowercased version of old UTF-8 $string (or $_, if
  $string is omitted). This is the internal function implementing the \L escape
  in double-quoted strings.

  You can use the Char::Eoldutf8::fc function for case-insensitive comparisons via Char::OldUTF8
  software.
...
=item Lower case first character of string
  ...
  This function returns a version of old UTF-8 $string with the first character
...
=item Upper case string
  ...
  This function returns an uppercased version of old UTF-8 $string (or $_, if
...
=item Fold case string
  ...
  New to Char::OldUTF8 software, this function returns the full Unicode-like casefold of
  old UTF-8 $string (or $_, if omitted). This is the internal function implementing
...
=item Filename expansion (globbing)
  ...
  The Char::Eoldutf8::glob function grandfathers the use of whitespace to separate multiple
