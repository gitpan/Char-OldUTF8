...
BEGIN {
    ...
    sub Char::Eoldutf8::binmode(*;$);
    sub Char::Eoldutf8::open(*;$@);
    ...
    if ($] < 5.006) {
        ...
        if ($^O ne 'MacOS') {
            *CORE::GLOBAL::binmode =
            *CORE::GLOBAL::binmode = \&Char::Eoldutf8::binmode;
        }
        *CORE::GLOBAL::open    =
        *CORE::GLOBAL::open    = \&Char::Eoldutf8::open;
    }
}
...
=item Make character
  ...
  set. For example, Char::Eoldutf8::chr(65) is "A" in either ASCII or old UTF-8, and
  Char::Eoldutf8::chr(0x82a0) is a old UTF-8 HIRAGANA LETTER A. For the reverse of Char::Eoldutf8::chr,
  use Char::OldUTF8::ord.
...
=item binary mode (Perl5.6 emulation on perl5.005)
  ...
  Char::Eoldutf8::binmode(FILEHANDLE, $disciplines);
  Char::Eoldutf8::binmode(FILEHANDLE);
  Char::Eoldutf8::binmode($filehandle, $disciplines);
  Char::Eoldutf8::binmode($filehandle);
...
=item open file (Perl5.6 emulation on perl5.005)
  ...
  $rc = Char::Eoldutf8::open(FILEHANDLE, $mode, $expr);
  $rc = Char::Eoldutf8::open(FILEHANDLE, $expr);
  $rc = Char::Eoldutf8::open(FILEHANDLE);
  $rc = Char::Eoldutf8::open(my $filehandle, $mode, $expr);
  $rc = Char::Eoldutf8::open(my $filehandle, $expr);
  $rc = Char::Eoldutf8::open(my $filehandle);
  ...
  * three arguments
  ...
  {
      my $fh;                          # (uninitialized)
      Char::Eoldutf8::open($fh, ">logfile")     # $fh is autovivified
  ...
  Char::Eoldutf8::open my $fh, ">logfile" or die ...
  ...
  Char::Eoldutf8::open(LOG, ">", "logfile") or die "Can't create logfile: $!";
  ...
  $path =~ s#^([ ])#./$1#;
  Char::Eoldutf8::open (FH, "< $path\0") or die "can't open $path: $!";
  ...
  Char::Eoldutf8::open(FH, "<", $path) or die "can't open $path: $!";
  ...
  Char::Eoldutf8::open(FH, "<:raw", $path) or die "can't open $path: $!";
  ...
  Char::Eoldutf8::open(FH, "<:crlf:encoding(Char::OldUTF8)", $path) or die "can't open $path: $!";
